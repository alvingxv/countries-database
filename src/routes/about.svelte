    ...
    <div class="max-w-screen-xl px-4 py-32 mx-auto lg:h-screen lg:items-center lg:flex">
      <div class="max-w-xl mx-auto text-center text-slate-200">
        ...
        <p class="mt-4 sm:leading-relaxed sm:text-xl">
          Hello, My name is Alvian "Alvin" Ghifari.
        </p>
        <p class="mt-4 sm:leading-relaxed sm:text-l">
            This is my first project on Front-end development using a framework. <br> In this Project, i use SvelteKit with TailwindCSS and Daisy UI for Styling .
        </p>
